...
public class LoginGUI extends Application {
    ...
    public void start(Stage primaryStage) {
        ...
        username_text.setStyle("-fx-background-color: #2A3D66; "
                + "-fx-text-fill: white; "
                + "-fx-border-color: #5C7DB5; "
                + "-fx-border-radius: 5px; "
                + "-fx-background-radius: 5px;");
        password_text.setStyle("-fx-background-color: #2A3D66; "
                + "-fx-text-fill: white; "
                + "-fx-border-color: #5C7DB5; "
                + "-fx-border-radius: 5px; "
                + "-fx-background-radius: 5px;");
    ...
    private void switchToStudentDashboard(Stage stage, String username) {
        try {
            ...
            Scene studentScene = studentGUI.createScene01();
    ...
    private  void switchToTeacherDashboard(Stage stage, String username){
        try {
            TeacherGUI teacherGUI = new TeacherGUI(username);
            Scene teacherScene = teacherGUI.createScene02();
