...
public class StudentGUI {
    ...
    public Scene createScene01() {
        ...
        studentIdField.setStyle("-fx-background-color: #2A3D66; "
                + "-fx-text-fill: white; "
        ...
        fetchButton.setStyle("-fx-background-color: #2A3D66; "
                + "-fx-text-fill: white; "
                + "-fx-border-color: #5C7DB5; "
                + "-fx-border-radius: 5px; "
                + "-fx-background-radius: 5px;");
        ...
        subjectCol.setStyle("-fx-alignment: CENTER;" + "-fx-background-color: #5C7DB5; "
                + "-fx-border-color: #696969; "
                + "-fx-border-radius: 5px; ");
